...
namespace PropertyRentalManagementWebSite.Controllers
{
    public class BuildingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BuildingId,Province,City,PostalCode,UserId")] Building building)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BuildingId,Province,City,PostalCode,UserId")] Building building)
        {
            if (ModelState.IsValid)
            {
